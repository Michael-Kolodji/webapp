...
import br.com.springboot.webapp.model.GrupoModel;
import br.com.springboot.webapp.model.UsuarioModel;
import br.com.springboot.webapp.service.GrupoService;
import br.com.springboot.webapp.service.UsuarioService;

/**
 * 
 * @author Michael Kolodji
 * 
...
public class UsuarioController {
	...
	public ModelAndView salvarUsuario(@ModelAttribute @Valid UsuarioModel usuarioModel, 
	...
	public ModelAndView consultar(Model model) {
		...
		model.addAttribute("usuarioModel", this.usuarioService.consultarUsuarios());
	...
	/***
	 * CONSULTA UM USUÁRIO PELO CÓDIGO PARA REALIZAR ALTERAÇÕES NAS INFORMAÇÕES CADASTRADAS.
	 * @param codigoUsuario
	 * @param model
	 * @return
	 */
