package br.com.springboot.webapp.entity;
...
@Table(name = "tb_grupo"/* , schema="postgres" */)
@Entity
public class GrupoEntity implements Serializable {
	...
	@Id
	@GeneratedValue(strategy=GenerationType.AUTO, generator="seq_id_grupo")
	...
	@ManyToMany
	@JoinTable(name="TB_PERMISSAO_X_GRUPO",
			joinColumns = @JoinColumn(name="id_grupo", referencedColumnName="id_grupo"),
